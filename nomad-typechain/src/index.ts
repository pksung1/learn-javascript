...
const createNewBlock = (data: string): Block => {
  ...
  const newhash: string = Block.calculateBlockHash(newIndex, previousBlock.hash, newTimeStemp, data);
  const newBlock: Block = new Block(newIndex, newhash, previousBlock.hash, data, newTimeStemp);
  addBlock(newBlock);
  return newBlock;
}
